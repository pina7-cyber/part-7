...
describe('favorite blog', () => {
  ...
  test('when list has only one blog, pick that one', () => {
    const result = listHelper.favoriteBlog(listWithOneBlog)
    expect(result).toEqual(favoriteBlog1)
  })

  test('of a bigger list is identified right', () => {
    const result = listHelper.favoriteBlog(listWithSeveralBlogs)
    expect(result).toEqual(favoriteBlog2)
  })
})
...
describe('author most blogs', () => {
  ...
  test('when list has only one blog', () => {
    ...
    expect(result).toEqual(mostBlogs1)
  })

  test('of a bigger list is identified right', () => {
    const result = listHelper.mostBlogs(listWithSeveralBlogs)
    expect(result).toEqual(mostBlogs2)
  })
})
...
describe('author most likes', () => {
  ...
  test('when list has only one blog', () => {
    ...
    expect(result).toEqual(mostLikes1)
  })

  test('of a bigger list is identified right', () => {
    const result = listHelper.mostLikes(listWithSeveralBlogs)
    expect(result).toEqual(mostLikes2)
  })
})